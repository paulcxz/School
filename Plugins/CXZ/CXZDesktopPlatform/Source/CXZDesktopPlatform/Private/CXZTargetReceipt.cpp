...
bool FCXZTargetReceipt::Read(const FString& FileName, bool bExpandVariables)
{
...
FString FCXZTargetReceipt::GetDefaultPath(const TCHAR* BaseDir, const TCHAR* TargetName, const TCHAR* Platform, EBuildConfiguration Configuration, const TCHAR* BuildArchitecture)
{
...
void FCXZTargetReceipt::ExpandVariables(FString& Path)
{
