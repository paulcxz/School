...
#define LOCTEXT_NAMESPACE "CXZPlatformInfo"
...
const FTargetPlatformInfo* FindPlatformInfo(const FName& InPlatformName)
{
	...
	for(const FTargetPlatformInfo* CXZPlatformInfo : AllPlatformInfoArray)
	{
		if(CXZPlatformInfo->Name == InPlatformName)
		{
			return CXZPlatformInfo;
		}
	}
...
void UpdatePlatformDisplayName(FString InPlatformName, FText InDisplayName)
{
	...
	for (FTargetPlatformInfo* CXZPlatformInfo : AllPlatformInfoArray)
	{
		if (CXZPlatformInfo->Name == FName(*InPlatformName))
		{
			CXZPlatformInfo->DisplayName = InDisplayName;
		}
	}
}
...
const TArray<FName>& GetAllPlatformGroupNames()
{
	...
	return CXZPlatformInfo::AllPlatformGroupNames;
}
...
const TArray<FName>& GetAllVanillaPlatformNames()
{
	...
	return CXZPlatformInfo::AllVanillaPlatformNames;
}
