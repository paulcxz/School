...
public class CXZDesktopPlatform : ModuleRules
{
	public CXZDesktopPlatform(ReadOnlyTargetRules Target) : base(Target)
	{
		//PrivateIncludePaths.Add("Developer/CXZDesktopPlatform/Private");
