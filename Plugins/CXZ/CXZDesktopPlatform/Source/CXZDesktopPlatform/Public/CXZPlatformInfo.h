...
namespace CXZPlatformInfo
{
	...
	{
		CXZDESKTOPPLATFORM_API FTargetPlatformInfo(const FString& InIniPlatformName, EBuildTargetType InType, const FString& InCookFlavor);
	 ...
	 */
	CXZDESKTOPPLATFORM_API const FTargetPlatformInfo* FindPlatformInfo(const FName& InPlatformName);
	 ...
	 * @return The platform info if the platform was found, null otherwise
	 */
	CXZDESKTOPPLATFORM_API const FTargetPlatformInfo* FindVanillaPlatformInfo(const FName& InPlatformName);

	/**
	 * Get an array of all the platforms we know about
	 * @return The pointer to the start of the platform array
	 */
	CXZDESKTOPPLATFORM_API const TArray<FTargetPlatformInfo*>& GetPlatformInfoArray();

	/**
	 * Get an array of only the vanilla platforms
	 * @return The pointer to the start of the platform array
	 */
	CXZDESKTOPPLATFORM_API const TArray<FTargetPlatformInfo*>& GetVanillaPlatformInfoArray();
	...
	*/
	CXZDESKTOPPLATFORM_API void UpdatePlatformDisplayName(FString InPlatformName, FText InDisplayName);
	...
	*/
	CXZDESKTOPPLATFORM_API const TArray<FName>& GetAllPlatformGroupNames();
	...
	* @return An array of FNames.
	*/
	CXZDESKTOPPLATFORM_API const TArray<FName>& GetAllVanillaPlatformNames();
}
