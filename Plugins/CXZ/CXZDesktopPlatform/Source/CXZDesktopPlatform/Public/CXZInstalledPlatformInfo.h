...
enum class ECXZInstalledPlatformState
{
 ...
 */
class CXZDESKTOPPLATFORM_API FCXZInstalledPlatformInfo
{
public:
	/**
	 * Accessor for singleton
	 */
	static FCXZInstalledPlatformInfo& Get()
	{
		static FCXZInstalledPlatformInfo InfoSingleton;
	 ...
	 */
	bool IsValid(TOptional<EBuildTargetType> TargetType, TOptional<FString> Platform, TOptional<EBuildConfiguration> Configuration, EProjectType ProjectType, ECXZInstalledPlatformState State) const;
